...
namespace ExternallyForcedFroudePendulum 
{
	...
	void Graph::SetupC(String ^xAxisName, double xAxisMaxVal, String ^yAxisName, double yAxisMaxVal)
	{
	...
	void Graph::SetupL(String ^xAxisName, double xAxisMaxVal, String ^yAxisName, double yAxisMaxVal)
	{
		this->xAxisName = xAxisName;
		this->yAxisName = yAxisName;
